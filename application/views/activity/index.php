...
<div class="container">
	...
	<p class="lead">
		...
		<label class="d-block">Parameters explained:</label>
		<dl class="row">
			<dt class="col-sm-4">1. To User <small>(34)</small></dt>
			<dd class="col-sm-8">The user who is receiving the activity (receipient)</dd>
			<dt class="col-sm-4">2. Activity Slug string <small>('INVITE_USER')</small></dt>
			<dd class="col-sm-8">The slug used for the activity message to define the type of activity that is being sent</dd>
			<dt class="col-sm-4">3. From User <small>(45)</small></dt>
			<dd class="col-sm-8">The user who is sending the activity (sender),<br>Can be 0 if system is sending the activity</dd>
			<dt class="col-sm-4">4. Other Activity Data <br><small>(array('user-email' => 'user1@example.com'))</small></dt>
